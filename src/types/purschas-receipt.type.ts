...
export const PurchaseReceiptSchemaZod = z.object({
  supplier_id: z.string("Supplier ID required"),
  warehouse_id: z.string("Warehouse ID required"),
  receipt_date: z.string("Receipt date required"),
  currency: z.string("Currency required"),
  lines: z.array(PurchaseLineSchema).min(1, "At least one line required"),
